...
void
gt_ggc_mx_VEC_loop_info_gc (void *x_p)
{
  struct VEC_loop_info_gc * const x = (struct VEC_loop_info_gc *)x_p;
    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_11loop_info_d ((*x).base.vec[i0]);
        }
      }
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_23VEC_range_check_info_gc ((*x).checks);
    }
}

void
gt_ggc_mx_VEC_range_check_info_gc (void *x_p)
{
  struct VEC_range_check_info_gc * const x = (struct VEC_range_check_info_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_18range_check_info_d ((*x).base.vec[i0]);
        }
      }
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_11VEC_tree_gc ((*x).other_ret_val);
    }
}

void
gt_pch_nx_VEC_loop_info_gc (void *x_p)
{
  struct VEC_loop_info_gc * const x = (struct VEC_loop_info_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_16VEC_loop_info_gc, gt_ggc_e_16VEC_loop_info_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_11loop_info_d ((*x).base.vec[i0]);
        }
      }
    }
}
...
{
  struct loop_info_d * const x = (struct loop_info_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_11loop_info_d, gt_ggc_e_11loop_info_d))
    {
      gt_pch_n_9tree_node ((*x).label);
      gt_pch_n_9tree_node ((*x).loop_var);
      gt_pch_n_23VEC_range_check_info_gc ((*x).checks);
    }
}

void
gt_pch_nx_VEC_range_check_info_gc (void *x_p)
{
  struct VEC_range_check_info_gc * const x = (struct VEC_range_check_info_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_23VEC_range_check_info_gc, gt_ggc_e_23VEC_range_check_info_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_18range_check_info_d ((*x).base.vec[i0]);
        }
      }
    }
}
...
{
  struct range_check_info_d * const x = (struct range_check_info_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18range_check_info_d, gt_ggc_e_18range_check_info_d))
    {
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_17language_function, gt_ggc_e_17language_function))
    {
      ...
      gt_pch_n_11VEC_tree_gc ((*x).other_ret_val);
    }
}

void
gt_pch_p_16VEC_loop_info_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_loop_info_gc * const x ATTRIBUTE_UNUSED = (struct VEC_loop_info_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).prefix.num);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_11loop_info_d (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct loop_info_d * const x ATTRIBUTE_UNUSED = (struct loop_info_d *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).label), cookie);
  if ((void *)(x) == this_obj)
...
void
gt_pch_p_23VEC_range_check_info_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_range_check_info_gc * const x ATTRIBUTE_UNUSED = (struct VEC_range_check_info_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).prefix.num);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_18range_check_info_d (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct range_check_info_d * const x ATTRIBUTE_UNUSED = (struct range_check_info_d *)x_p;
  if ((void *)(x) == this_obj)
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_ada_trans_h[] = {
  ...
  },
  {
    ...
    &gt_ggc_mx_VEC_loop_info_gc,
    &gt_pch_nx_VEC_loop_info_gc
  },
  {
