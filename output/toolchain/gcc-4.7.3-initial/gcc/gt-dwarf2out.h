...
void
gt_ggc_mx_VEC_dw_line_info_table_p_gc (void *x_p)
{
  struct VEC_dw_line_info_table_p_gc * const x = (struct VEC_dw_line_info_table_p_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_25dw_line_info_table_struct ((*x).base.vec[i0]);
        }
      }
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_25VEC_dw_line_info_entry_gc ((*x).entries);
    }
}

void
gt_ggc_mx_VEC_dw_line_info_entry_gc (void *x_p)
{
  struct VEC_dw_line_info_entry_gc * const x = (struct VEC_dw_line_info_entry_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
...
void
gt_ggc_mx_VEC_dw_fde_ref_gc (void *x_p)
{
  struct VEC_dw_fde_ref_gc * const x = (struct VEC_dw_fde_ref_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_13dw_fde_struct ((*x).base.vec[i0]);
        }
      }
    }
}
...
gt_pch_nx_call_arg_loc_node (void *x_p)
{
  struct call_arg_loc_node * x = (struct call_arg_loc_node *)x_p;
  struct call_arg_loc_node * xlimit = x;
  while (gt_pch_note_object (xlimit, xlimit, gt_pch_p_17call_arg_loc_node, gt_ggc_e_17call_arg_loc_node))
   xlimit = ((*xlimit).next);
  while (x != xlimit)
    {
...
void
gt_pch_nx_VEC_dw_line_info_table_p_gc (void *x_p)
{
  struct VEC_dw_line_info_table_p_gc * const x = (struct VEC_dw_line_info_table_p_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_27VEC_dw_line_info_table_p_gc, gt_ggc_e_27VEC_dw_line_info_table_p_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_25dw_line_info_table_struct ((*x).base.vec[i0]);
        }
      }
    }
}
...
{
  struct dw_line_info_table_struct * const x = (struct dw_line_info_table_struct *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_25dw_line_info_table_struct, gt_ggc_e_25dw_line_info_table_struct))
    {
      gt_pch_n_S ((*x).end_label);
      gt_pch_n_25VEC_dw_line_info_entry_gc ((*x).entries);
    }
}

void
gt_pch_nx_VEC_dw_line_info_entry_gc (void *x_p)
{
  struct VEC_dw_line_info_entry_gc * const x = (struct VEC_dw_line_info_entry_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_25VEC_dw_line_info_entry_gc, gt_ggc_e_25VEC_dw_line_info_entry_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
...
void
gt_pch_nx_VEC_dw_fde_ref_gc (void *x_p)
{
  struct VEC_dw_fde_ref_gc * const x = (struct VEC_dw_fde_ref_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_17VEC_dw_fde_ref_gc, gt_ggc_e_17VEC_dw_fde_ref_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_13dw_fde_struct ((*x).base.vec[i0]);
        }
      }
    }
}
...
gt_pch_p_17call_arg_loc_node (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct call_arg_loc_node * const x ATTRIBUTE_UNUSED = (struct call_arg_loc_node *)x_p;
  if ((void *)(x) == this_obj)
...
void
gt_pch_p_27VEC_dw_line_info_table_p_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_dw_line_info_table_p_gc * const x ATTRIBUTE_UNUSED = (struct VEC_dw_line_info_table_p_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).prefix.num);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_25dw_line_info_table_struct (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct dw_line_info_table_struct * const x ATTRIBUTE_UNUSED = (struct dw_line_info_table_struct *)x_p;
  if ((void *)(x) == this_obj)
...
void
gt_pch_p_25VEC_dw_line_info_entry_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_dw_line_info_entry_gc * const x ATTRIBUTE_UNUSED = (struct VEC_dw_line_info_entry_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).prefix.num);
    for (i0 = 0; i0 != l0; i0++) {
...
void
gt_pch_p_17VEC_dw_fde_ref_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_dw_fde_ref_gc * const x ATTRIBUTE_UNUSED = (struct VEC_dw_fde_ref_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).prefix.num);
    for (i0 = 0; i0 != l0; i0++) {
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dwarf2out_h[] = {
  ...
  },
  {
    ...
    &gt_ggc_mx_VEC_dw_line_info_table_p_gc,
    &gt_pch_nx_VEC_dw_line_info_table_p_gc
  },
  {
  ...
  },
  {
    ...
    1,
    sizeof (fde_vec),
    &gt_ggc_mx_VEC_dw_fde_ref_gc,
    &gt_pch_nx_VEC_dw_fde_ref_gc
  },
  {
    &debug_frame_section,
    1,
