  ...
  if (ggc_test_and_set_mark (x))
    {
      if ((*x).slots != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).number_of_slots); i0++) {
      ...
      if ((*x).values != NULL) {
        size_t i1;
        for (i1 = 0; i1 != (size_t)(((*x)).number_of_slots); i1++) {
...
{
  struct objc_map_private * const x = (struct objc_map_private *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_16objc_map_private, gt_ggc_e_16objc_map_private))
    {
      if ((*x).slots != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).number_of_slots); i0++) {
        ...
        gt_pch_note_object ((*x).slots, x, gt_pch_p_16objc_map_private, gt_types_enum_last);
      }
      if ((*x).values != NULL) {
        size_t i1;
        for (i1 = 0; i1 != (size_t)(((*x)).number_of_slots); i1++) {
        ...
        gt_pch_note_object ((*x).values, x, gt_pch_p_16objc_map_private, gt_types_enum_last);
      }
    }
}
...
{
  struct objc_map_private * const x ATTRIBUTE_UNUSED = (struct objc_map_private *)x_p;
  if ((*x).slots != NULL) {
    size_t i0;
    for (i0 = 0; i0 != (size_t)(((*x)).number_of_slots); i0++) {
