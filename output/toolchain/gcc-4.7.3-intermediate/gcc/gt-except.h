...
{
  struct call_site_record_d * const x = (struct call_site_record_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18call_site_record_d, gt_ggc_e_18call_site_record_d))
    {
...
{
  struct call_site_record_d * const x ATTRIBUTE_UNUSED = (struct call_site_record_d *)x_p;
  if ((void *)(x) == this_obj)
