...
enum attr_cpu {CPU_NONE, CPU_PENTIUM, CPU_PENTIUMPRO, CPU_GEODE, CPU_K6, CPU_ATHLON, CPU_K8, CPU_CORE2, CPU_COREI7, CPU_ATOM, CPU_GENERIC64, CPU_AMDFAM10, CPU_BDVER1, CPU_BDVER2, CPU_BTVER1};
...
enum attr_isa {ISA_BASE, ISA_SSE2, ISA_SSE2_NOAVX, ISA_SSE3, ISA_SSE4, ISA_SSE4_NOAVX, ISA_NOAVX, ISA_AVX, ISA_BMI2, ISA_FMA4, ISA_FMA};
